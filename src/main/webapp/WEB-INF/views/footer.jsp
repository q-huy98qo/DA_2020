						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							...
							<div class="footer_block">
								...
								<div class="block_content">
									<ul class="list_group">
										<li class="item"><a href="introduce"> Giới
												thiệu </a></li>
										<li class="item"><a href="introduce">
												Giao h&#224;ng - Đổi trả </a></li>
										<li class="item"><a
											href="content/chinh-sach-bao-mat.html"> Ch&#237;nh
												s&#225;ch bảo mật </a></li>
										<li class="item"><a href="contact"> Li&#234;n hệ
										</a></li>
									</ul>
								</div>
							</div>
								...
								<div class="block_content">
									...
									<form id="newsletter_form" class="m-b-20 contact-form">
										<div class="newsletter_wrap">
											<input id="contact_email" autocomplete="off" type="email">
							...
							<div class="footer_block">
								...
								<div class="block_content">
									<div class="fb-page" data-small-header="true"
										data-href="https://www.facebook.com/runtime.vn"
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="footer_address">
								<p>
									<span>C&#212;NG TY TNHH PH&#193;T TRIỂN C&#212;NG NGHỆ
										RUNTIME</span>
								</p>
								<p>
									<span>Địa chỉ: 5/12A Quang Trung, P.14, Q.G&#242; Vấp,
										Tp.HCM</span>
								</p>
								<p>
								...
								<p>
									<span>Số di động: 0908 77 00 95</span>
								</p>
								<p>
									<span>Email: runecom04@runtime.vn</span>
								</p>
							</div>
						</div>
